...
import com.cognizant.user.cmd.api.user.commands.RegisterUserCommand;
import com.cognizant.user.cmd.api.user.commands.RemoveUserCommand;
import com.cognizant.user.cmd.api.user.commands.UpdateUserCommand;
